...
if st.session_state["vista"] == "Llamada en curso":
    ...
    st.caption("**Instrucciones:** Usa `Supr/Delete` para iniciar una llamada y `Mayús/Shift` para terminar. Maniobra con teclado y, como último recurso usa el botón único.")
